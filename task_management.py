...
# “Here’s some work to do — please schedule it and
# resume it whenever it can make progress.”

# When you call asyncio.create_task(coro()),
# you don’t just create a coroutine object — you tell the event loop to run it
...
async def sub_main():
    ...
    results = await asyncio.gather(
        task, task2
    )  # Waiting for Tasks # You can await task to get its result
    print(results)
    # Task Groups
